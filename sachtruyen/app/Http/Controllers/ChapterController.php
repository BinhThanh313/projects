...
class ChapterController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'slug_chapter.unique' => 'Slug đã có, vui lòng chọn slug khác',
            'tiende.unique' => 'Tiêu đề đã có, vui lòng chọn tiêu đề khác',
    ...
    public function update(Request $request, $id)
    {
        $data = $request->validate([
            ...
            'slug_chapter.unique' => 'Slug đã có, vui lòng chọn slug khác',
            'tieude.unique' => 'Tiêu đề đã có, vui lòng chọn tiêu đề khác',
            'tieude.required' => 'Phải có tiêu đề',
            'tomtat.required' => 'Phải có tóm tắt chapter',
            'noidung.required' => 'Phải có nội dung chapter',
            'slug_chapter.required' => 'Phải có slug chapter',
